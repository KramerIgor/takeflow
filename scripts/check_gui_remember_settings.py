...
def main() -> int:
    ...
    print("contains_storage_key=", "seedance_gui_form_preferences_v1" in text, sep="")
    ...
    print("contains_localstorage_set=", "localStorage.setItem" in text, sep="")
    print("contains_localstorage_get=", "localStorage.getItem" in text, sep="")

    ok = (
        response.status_code == 200
        and "seedance_gui_form_preferences_v1" in text
        and '"model"' in text
        and '"duration"' in text
        and '"resolution"' in text
        and '"aspect_ratio"' in text
        and "localStorage.setItem" in text
        and "localStorage.getItem" in text
    )
