...
- точечное обновление только активных карточек без очистки промпта, сброса курсора и перезагрузки готовых видеоплееров;
- явная галочка «Случайный seed» и сохранение фактического seed, когда Segmind возвращает его;
- немедленное применение API-ключа и API base; выбранная модель запоминается на рабочих формах;
