...
def main() -> int:
    ...
    checks = [
        expect("version_constant_ok", APP_VERSION == "0.1.4beta"),
        expect("release_tag_ok", APP_RELEASE_TAG == "v0.1.4-beta"),
        ...
        expect("readme_mentions_installer", "Windows Installer" in readme and "v0.1.4-beta" in readme and "TakeflowSetup-*.exe" in readme),
