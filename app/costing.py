...
TEXT_IMAGE_RATES_USD_PER_SECOND: dict[str, dict[str, dict[str, float]]] = {
    ...
    "seedance-2.0-mini": {
        "480p": {"16:9": 0.0352, "4:3": 0.0345, "1:1": 0.0336, "3:4": 0.0345, "9:16": 0.0352, "21:9": 0.0352},
        "720p": {"16:9": 0.0756, "4:3": 0.0761, "1:1": 0.0756, "3:4": 0.0761, "9:16": 0.0756, "21:9": 0.0760},
    },
}
...
VIDEO_TYPICAL_RATES_USD_PER_SECOND: dict[str, dict[str, float]] = {
    ...
    "seedance-2.0-mini": {"480p": 0.045, "720p": 0.095},
}
