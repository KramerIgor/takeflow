...
def main() -> int:
    ...
    dynamic_en_keys = [
        ...
        "confirm_retry_queue",
        "confirm_delete_error_record",
        "send_again",
        "add_to_queue_again",
        "check_failed_result",
        "delete_error_record",
        "technical_error",
        "generation_error_connection",
        "generation_error_timeout",
        "generation_error_auth",
        "generation_error_balance",
        "generation_error_capacity",
        "generation_error_parameters",
        "generation_error_reference_upload",
        "generation_error_download",
        "generation_error_generic",
