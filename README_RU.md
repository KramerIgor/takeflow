...
Текущий релиз: **0.1.1 beta** (`v0.1.1-beta`).

## Скачать для Windows

Откройте [последний релиз на GitHub](https://github.com/KramerIgor/takeflow/releases/latest):
...
3. Выберите доступную для записи корневую папку.
