...
document.addEventListener("DOMContentLoaded", function () {
      ...
      const translations = {
        ru: {
          ...
          shutdown_complete: "Takeflow выключен",
          shutdown_safe_to_close: "Эту вкладку можно закрыть.",
          close_tab: "Закрыть вкладку",
          shutdown_failed: "Не удалось выключить Takeflow",
          ...
          processing_notice: "Генерация выполняется. История обновляется автоматически.",
          estimated_progress: "Примерный прогресс",
          waiting_to_start: "Ожидает запуска",
          estimated_time: "Примерное время",
          seconds_short: "сек",
          seconds_remaining: "сек осталось",
          taking_longer_than_estimate: "Дольше обычного",
        ...
        en: {
          ...
          shutdown_complete: "Takeflow is off",
          shutdown_safe_to_close: "You can close this tab.",
          close_tab: "Close tab",
          shutdown_failed: "Takeflow could not be shut down",
          estimated_progress: "Estimated progress",
          waiting_to_start: "Waiting to start",
          estimated_time: "Estimated time",
          seconds_short: "sec",
          seconds_remaining: "sec remaining",
          taking_longer_than_estimate: "Taking longer than estimated",
