...
Current release: **0.1.4 beta** (v0.1.4-beta).

## Download for Windows

Download the latest installer from [Takeflow 0.1.4 beta](https://github.com/KramerIgor/takeflow/releases/tag/v0.1.4-beta):
